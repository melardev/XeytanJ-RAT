...
public class CommandLineClientBuilder implements IClientBuilder {
    ...
    public boolean build(BuildClientInfoStructure buildClientInfoStructure) {
        ...
        if (ff.getProtocol().contains("file")) {
            ...
            if (!file.exists()) {
                MessageDialogFactory.showErrorMessage("Not Found Error", "xeytanj-client.jar file not found, build the client and export it" +
                        " as a jar file, that file place it in the server's directory");
                return false;
            }
...
*/
    ...
    public static void main(String[] args) {
        ...
        builder.build(new BuildClientInfoStructure("localhost", "9000", 3000, "xeytanj", true,
                new File("./output.jar")));
